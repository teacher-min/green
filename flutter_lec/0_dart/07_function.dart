...
// 3. 반환타입 생략하기 (dart가 추론해서 결정)
add3(a, b) {
  return a + b;
}

// 4. 화살표 함수 ( 문법 : () => 단일표현식 )
// 항상 단일표현식의 결과값을 반환합니다. (return 필요 없음)
...
void info3(String name, [int age = 30]) {
...
void main() {
  ...
  print(add5(9, 10));
  info1("tom", 20);
  info2(name: "tom", age: 20); // named parameter 로 값 전달하기
  info2(age: 20, name: "tom");
  info3("tom", 20);
  info3("tom"); // 디폴트 값 사용
  info4(name: "tom", age: 20);
