...
class ApplicationTests {
  ...
  void 일대다_객체_insert_test() {
    ...
    // 등록한 신규 카테고리 조회
    Category foundCategory = entityManager.find(Category.class, 20);
