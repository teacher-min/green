...
public class WebMvcConfig implements WebMvcConfigurer {
  ...
  public void addCorsMappings(CorsRegistry registry) {
    registry.addMapping("/**")
            ...
            .allowedHeaders("Authorization", "Cache-Control", "Content-Type");  // "Origin", "Cache-Control", "Accept", "X-Requested-With", "Content-Type", "Access-Control-Request-Method", "Access-Control-Request-Headers", "Authorization"
  }
