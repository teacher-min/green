...
class ApplicationTests {
  ...
  void 결과_타입_명시_select_test() {
    ...
    String sql = "SELECT menu_code, menu_name, menu_price, category_code, orderable_status FROM tbl_menu";  // 모든 칼럼을 의미하는 * 도 사용 가능합니다.
  ...
  void 내부_조인_test() {
    ...
    sql.append("SELECT m.menu_code, m.menu_name, m.menu_price, m.category_code, m.orderable_status, c.category_name");
    sql.append("  FROM tbl_category c");
    sql.append(" INNER JOIN tbl_menu m");
    sql.append("    ON c.category_code = m.category_code");
